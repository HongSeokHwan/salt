...
#ffmpeg -i "media_path/09.mp4" -c:v libx264 -preset slow -b:v 1024k -c:a aac -b:a 64k -f mp4 "media_path/output.mp4"

#ffmpeg -i "media_path/09.mp4" -c:v libx264 -preset slow -b:v 1024k -c:a aac -b:a 64k -f mp4 -ss 00:01:00 -t 00:01:15 "media_path/output.mp4"
